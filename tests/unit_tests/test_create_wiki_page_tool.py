...
from langchain_taiga.tools.taiga_tools import create_wiki_page_tool
...
class TestCreateWikiPageUnit(ToolsUnitTests):
    @property
    def tool_constructor(self) -> BaseTool:
        return create_wiki_page_tool
    ...
    def tool_invoke_params_example(self) -> dict:
        ...
        return {
            "project_slug": "slug",
            "wiki_slug": "sprint-retrospective",
