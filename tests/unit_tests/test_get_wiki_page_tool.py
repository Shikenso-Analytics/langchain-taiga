...
from langchain_taiga.tools.taiga_tools import get_wiki_page_tool
...
class TestGetWikiPageUnit(ToolsUnitTests):
    @property
    def tool_constructor(self) -> BaseTool:
        return get_wiki_page_tool
    ...
    def tool_invoke_params_example(self) -> dict:
        ...
        """
        return {"project_slug": "slug", "wiki_slug": "home"}
